...
class HonorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create honor" do
    assert_difference('Honor.count') do
      post honors_url, params: { honor: { description: @honor.description, judge_id: @honor.judge_id } }
    end
  ...
  test "should update honor" do
    patch honor_url(@honor), params: { honor: { description: @honor.description, judge_id: @honor.judge_id } }
